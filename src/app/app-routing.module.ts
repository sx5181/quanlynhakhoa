...
// Auth
import { TrangchuComponent } from './views/pages/trangchu/trangchu.component';
...
import { DanhsachCapduoiComponent } from './views/pages/khachhang/danhsach-capduoi/danhsach-capduoi.component';


const routes: Routes = [
	{ path: 'auth', loadChildren: () => import('app/views/pages/auth/auth.module').then(m => m.AuthModule) },
	// { path: 'khachhang/danhsach-capduoi', component: DanhsachCapduoiComponent },
	{
		path: '',
		...
		children: [
			...
			{
				path: 'khachhang',
				loadChildren: () => import('app/views/pages/khachhang/khachhang.module').then(m => m.KhachhangModule),
				canActivate: [AuthGuard],
				// data: { "roles": [Role.Admin] },
				// component: AdminModule
			},
			{
				path: 'nhaplieu',
				loadChildren: () => import('app/views/pages/nhaplieu/nhaplieu.module').then(m => m.NhaplieuModule),
				canActivate: [AuthGuard],
				// data: { "roles": [Role.Admin] },
				// component: AdminModule
			},
			{ path: 'profile', loadChildren: () => import('app/views/pages/profile/profile.module').then(m => m.ProfileModule) },
