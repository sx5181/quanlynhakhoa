			...
			items: [
					...
					submenu: [
						{
							...
							page: 'admin/quanlytaikhoan/manager-user/list',
							permission: 'accessToECommerceModule'
						},
						{
							title: 'Quản lý doanh số',
							page: '/admin/quanlydoanhso',
							permission: 'accessToECommerceModule'
						},
						{
							title: 'Thống kê',
					...
					submenu: [
						{
							...
							page: '/khachhang/thongtin-doanhso',
							// permission: 'accessToECommerceModule'
						},
						{
							title: 'Danh sách cấp dưới',
							page: '/khachhang/danhsach-capduoi',
							// permission: 'accessToECommerceModule'
						},
						{
							title: 'Đặt lịch khám',
							page: '/khachhang/datlichkham',
							// permission: 'accessToECommerceModule'
						},
						{
							title: 'Thông tin khuyến mại',
							page: '/khachhang/thongtin-khuyenmai',
							// permission: 'accessToECommerceModule'
						},
						{
							title: 'Danh sách liên kết',
							page: '/khachhang/danhsach-lienket',
							// permission: 'accessToECommerceModule'
						}
					]
				},
				{
					...
					submenu: [
						{
							title: 'Nhập hóa đơn',
							page: '/nhaplieu/nhaphoadon',
							// permission: 'accessToECommerceModule'
						},
						{
							title: 'Danh mục khách hàng',
							page: '/nhaplieu/danhsach-khachhang',
							// permission: 'accessToECommerceModule'
						},
						{
							title: 'Lịch khám đã đặt',
							page: '/nhaplieu/danhsach-lichkham',
							// permission: 'accessToECommerceModule'
						},
						{
							title: 'Đăng khuyen mai',
							page: '/nhaplieu/dangkhuyenmai',
							permission: Role.Collaborators
						},
						{
							title: 'Quản lý mẫu email',
							page: '/nhaplieu/danhsach-mauemail',
							// permission: 'accessToECommerceModule'
						},
						{
							title: 'Thống kê',
							page: '/nhaplieu/thongke',
							// permission: 'accessToECommerceModule'
						},
					]
				}
