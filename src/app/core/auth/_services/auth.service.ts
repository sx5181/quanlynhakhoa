...
const API_USERS_URL = 'https://localhost:44314/token';
const API_PERMISSION_URL = 'https://localhost:44314/api/permissions';
const API_ROLES_URL = 'https://localhost:44314/api/GetAllRoles';
...
export class AuthService {
    ...
    login(username: string, password: string): Observable<User> {
        ...
        return this.http.post<User>(API_USERS_URL, data, { headers: reqHeader });
    }
